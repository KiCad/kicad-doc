...
Some fonts are required to build i18n pdfs. Using SINGLE_LANGUAGE option, you can avoid to get the build errors.

==== VL Gothic

VL Gothic font is required, when you build japaese pdfs. (e.g. `sudo apt-get install fonts-vlgothic`)
