...
* `Delete`: deletes a footprin or a track. (_Available only if the Footprint tool or the track tool is active_)
...
|====
.16+^.^|image:images/Pcbnew_right_toolbar.png[]
...
[width="100%",cols="10%,5%,85%",]
|====
.17+^.^|image:images/Pcbnew_left_toolbar.png[]
