...
[width="77%",cols="50%,50%",]
|================================================================
|image:images/2170000015C98B9D826.png[2170000015C98B9D826_png]
a|image:images/0F300000102C5881F3E.png[0F300000102C5881F3E_png]
...
|=================================================================
|image:images/0FE0000008C8F0A84EF.png[0FE0000008C8F0A84EF_png]
a|Page 1 option:
...
a|The right window is the edit window.

On this dialog you can set the page property
and the item property of the current item.

|=======================================================================

Displayed settings depend on the selected item:

[width="100%",cols="33%,34%,33%",]
|=======================================================================
