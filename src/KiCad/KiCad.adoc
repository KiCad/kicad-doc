...
* for the path of these librairies, when installed on your disk
...
_Preferences/PDF Viewer_/_Favourite PDF Viewer_

To choose your favourite (default) PDF Viewer

Your own (non default) viewer is chosen by using the  

_Preferences/PDF Viewer_/_SetPDF Viewer_  
