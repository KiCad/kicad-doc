...
Select the module with the right mouse button then chose the Move
...
The automatic module of placement allows the placement of the modules
...
Usually resistances and non-polarized capacitors are authorized for
