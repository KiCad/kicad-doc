...
Under Linux, the easiest way to install KiCad is via __Aptitude__. Type
into your Terminal:
...
to download a pre-build binary from:
...
image:images/10000000000004DD000002BDCE77181D.png[10000000000004DD000002BDCE77181D_png]

In the picture above, the greyed out blocks indicate component-drawing
and footprint-drawing tools that are not strictly part of KiCad.
However, since they are all very valuable options, do not forget to
check them out. You can find some at this address:
...
From here you have access to five stand-alone software tools:
__EESchema__, __Cvpcb__, __PCBnew__, _GerbView_ and
__Bitmap2Component__. Refer to the work-flow chart for an idea of what
all these tools are used for.
+
image:images/kicad_main_window.png[kicad_main_window_png]
...
'Front' in the drag down menu on the top toolbar. This is the top copper
layer.
image:images/10000000000000D30000010D5271F1F8.png[10000000000000D30000010D5271F1F8_png]
...
default 0.203 mm. You can change the track width from the drop-down menu
in the top toolbar. Mind that by default you have only one track width
available. image:images/pcbnew_1.png[pcbnew_1_png]
...
image:images/10000000000001F0000001553F56DF17.png[10000000000001F0000001553F56DF17_png]
...
shortcut.
image:images/10000000000003320000023622705DB3.png[10000000000003320000023622705DB3_png]
