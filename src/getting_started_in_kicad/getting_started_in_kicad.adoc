...
If these files are missing, they are available via the following
commands (change the *.xsl file name as desired):
---------
...
You can find the included *.xsl files at
_<KiCad install directory>/Library/Application Support/kicad/plugins/_.

*Windows:*

xsltproc.exe the included *.xsl files can be found at
