...
If you need xsltproc, use the following to download and install it:
---------
brew install libxslt
---------

You will find xsl files at: _/Library/Application Support/kicad/plugins/_.

*Windows:*

xsltproc.exe and the included xsl files will be installed at
_\bin_ and _\bin\scripting\plugins_, respectively.
