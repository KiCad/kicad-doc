...
+
image:images/cvpcb.png[cvpcb_png]
...
49. It is possible that the pane on the right shows only a selected
    ...
    icons image:images/module_filtered_list.png[module_filtered_list_png],
    image:images/module_pin_filtered_list.png[module_pin_filtered_list_png] and
    image:images/module_library_list.png[module_library_list_png] to
...
|B.Cu (ex Copper) |Bottom Layer |.GBL
|F.Cu (ex Component) |Top Layer |.GTL
|F.SilkS (ex SilkS_Cmp) |Top Overlay |.GTO
|B.Mask (ex Mask_Cop) |Bottom Solder Resist |.GBS
|F.Mask (ex Mask_Cmp) |Top Solder Resist |.GTS
|Edge.Cuts (ex Edges_Pcb) |Edges |N/A
|=========================================================
...
9.  Go to *Preferences* -> *Library* and add both _tutorial1/library/_ in
...
5.  Have a look at it using KiCad. From the KiCad project manager, start
    ...
    icon image:images/import.png[import_png], navigate to _tutorial1/library/_
