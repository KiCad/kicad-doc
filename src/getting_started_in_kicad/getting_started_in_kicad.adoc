...
14. In case you make a mistake and want to delete a component, right
    ...
    component you want to delete and press the Delete key.
...
1.  Let us suppose that you have three 4-pin connectors that you want
    ...
    press the Insert key to have the same item automatically
    added on the pin below pin 4 (PIN 3). Notice how the label is
    automatically renamed 'a2'.

2.  Press the Insert key two more times. This key corresponds to the
...
+
NOTE: The 'Repeat last item' option accessible via the Insert key can
...
11. The 'Repeat last item' option accessible via the Insert key has also
...
re-route it again, using the Delete key and the routing tool, which is the
