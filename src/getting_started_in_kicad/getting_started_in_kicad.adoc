...
IMPORTANT: KiCad stable releases occur periodically per the "KiCad Stable
...
.Stable builds
Stable releases of KiCad can be found in most distibution's package
managers as kicad and kicad-doc. If your distribution do not provide
