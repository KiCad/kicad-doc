...
symbols. These connections are referred to as nets.  In the netlist
file you can find:
...
* PCB layout software.
* Schematic and electectical signal simulators.
...
to open the netlist creation dialog.
...
component names, pins, nets or other informations. Avoid using
