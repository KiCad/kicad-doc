...
image::images/schematic-sample.png[alt="Schematic sample",scaledwidth="95%"]
...
image::images/10000000000000FC000000C867B9348F.png[alt="10000000000000FC000000C867B9348F_png",scaledwidth="50%"]

Here is what the configuration data for the PadsPcb tab looks like:

image::images/100000000000026D000001272BA6B200.png[alt="100000000000026D000001272BA6B200_png",scaledwidth="80%"]
...
1.  Eeschema creates an intermediate netlist file __.xml, for instance__test.xml.*
...
_%I_ will be replaced by the actual intermediate file name

_%O_ will be replaced by the actual output file name.
