...
The configuration parameters are saved in the .pro file. Different configuration files in different directories are also possible.
...
Various drawing elements, colur selection and background colur (black or white only).
...
|                                                               |                                                                                                                      |
+---------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------+
| Show hidden pins:                                             | Display invisible (or                                                                                                |
|                                                               | *hidden*                                                                                                             |
|                                                               | ) pins .                                                                                                             |
|                                                               |                                                                                                                      |
...
|                                                               |                                                                                                                      |
+---------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------+
| Enable                                                        | When enabled, when the middle mouse button is pressed, the entire sheet is moved, following the cursor               |
| middle mouse button                                           |                                                                                                                      |
| panning                                                       |                                                                                                                      |
|                                                               |                                                                                                                      |
+---------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------+
...
|                                                               |                                                                                                                      |
+---------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------+
| Allow buses and wires to be placed in H or V orientation only | If checked buses and wires can be only vertical or horizontal.                                                       |
|                                                               |                                                                                                                      |
|                                                               | Else                                                                                                                 |
...
Use default mode. Other languages are available mainly for maintenance purpose.
